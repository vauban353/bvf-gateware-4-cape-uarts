...
sd_create_scalar_port -sd_name ${sd_name} -port_name {P8_PIN13_USER_LED_10} -port_direction {INOUT} -port_is_pad {1}
...
sd_create_scalar_port -sd_name ${sd_name} -port_name {P8_PIN19} -port_direction {INOUT} -port_is_pad {1}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CAPE_DEFAULT_GPIOS:GPIO_10_PAD" "P8_PIN13_USER_LED_10" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CAPE_DEFAULT_GPIOS:GPIO_16_PAD" "P8_PIN19" }
