...
sd_create_scalar_port -sd_name ${sd_name} -port_name {GPIO_16_PAD} -port_direction {INOUT} -port_is_pad {1}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"GPIO_16_BIBUF:PAD" "GPIO_16_PAD" }
