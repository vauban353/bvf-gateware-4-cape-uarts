...
#sd_create_scalar_port -sd_name ${sd_name} -port_name {P8_PIN37} -port_direction {OUT} -port_is_pad {1}
#sd_create_scalar_port -sd_name ${sd_name} -port_name {P8_PIN38} -port_direction {IN} -port_is_pad {1}
