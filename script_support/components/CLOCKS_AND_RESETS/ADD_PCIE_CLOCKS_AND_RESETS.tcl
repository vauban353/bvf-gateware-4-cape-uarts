...
#-------------------------------------------------------------------------------
# Rename top level ports.
#-------------------------------------------------------------------------------
sd_rename_port -sd_name {CLOCKS_AND_RESETS} -current_port_name {REF_CLK_PAD_N} -new_port_name {XCVR_0A_REFCLK_N} 
sd_rename_port -sd_name {CLOCKS_AND_RESETS} -current_port_name {REF_CLK_PAD_P} -new_port_name {XCVR_0A_REFCLK_P} 
